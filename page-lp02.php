...
$title = "ヘッジファンドダイレクト株式会社｜ヘッジファンドで下げ相場でも勝つ投資を";
...
<head>
    ...
    <link rel="icon" href="<?php bloginfo('template_directory') ?>/img/lp/texted02/favicon.ico">
    ...
    <meta property="og:image" content="<?php bloginfo('template_directory') ?>/img/lp/texted02/ogp_img.jpg" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Amiri:wght@700&family=Noto+Sans+JP:wght@400;500;700&family=Noto+Serif+JP:wght@500;900&family=Roboto:wght@400;500;700;900&family=Roboto:wght@500&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/css/style_textedLp02.css">
</head>
<body>
    ...
    <div id="wrapper">
        ...
        <header>
            <div class="inner">
                <h1 class="logomark"><img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/logomark.svg" alt="ヘッジファンドダイレクト株式会社"></h1>
                <div class="contact">
        ...
        <div id="container" class="">
            <div class="edit-area keyvisual">
                <div class="inner w960">
                    <div class="only2000 spmode">
                        <p>【ご投資額 2,000万円から】</p>
                    </div>
                    <div class="sub-catch"><span>下げ相場</span>でも<span>リターン</span>を</div>
                    <div class="main-catch"><span><span>ヘッジファンド</span>で</span><br>
                        <span class="fv_txt_mezasu"><span>勝ち続ける資産運用</span>を目指す</span>
                    </div>
                </div>
                <div class="campaign">
                    <div class="box">
                        <p>投資額<br><span>2,000</span>万円<br>以上の方限定</p>
                    </div>
                </div>
            </div>
            <!-- edit-area keyvisual -->
				...
				<div class="bottomCtaInner">
					<ul>
						<li class="tell">
							...
							<div class="spmode">
								<a href="tel:0120-104-359"><img src="<?php echo $siteUrl; ?>/wp-content/themes/hedgefund/img/lp/texted01/tel-icon01.svg" alt="電話問合せ"></a>
							</div>
						</li>
            ...
            <div class="edit-area type01">
                <div class="block-num01">                  
                    <div class="inner w960">
                        <h2>資産運用に<span class="">不安</span>を<br class="spmode">抱えていませんか？</h2>
                        <div class="box">
                        <p>投資は常にあらゆるリスクと隣り合わせ。<br>
                            ここ数年、コロナ、戦争、金利、為替などの影響であなたの資産は乱高下しませんでしたか？<br>
                            <span>下げ相場が続いた2022年、最先端の金融テクノロジーに基づいたヘッジファンドBは、年間で25.2％のリターンを達成</span><br>
                        (2022年12月末時点、助言実績一例）</p>
                        </div>
                        <ul>
                            <li><span>投資信託での<br>損を取り返したい</span></li>
                            <li><span>証券マンの<br>言う通りにして<br>失敗した</span></li>
                            <li><span>今後自分の資産が<br>減らないか心配</span></li>
                            <li><span>もう損失額を<br>増やしたくない</span></li>
                        </ul>
                    </div>
                </div>
                <div class="block-num02">                  
                    <div class="inner w960">
                        <dl>
                            <dt>そのお悩み、<br class="spmode">ヘッジファンドダイレクトが<br class="spmode">お力になります</dt>
                            <dd>
                                <ul>
                                    <li>下げ相場でもリターンを出したファンドがある</li>
                                    <li>あなたと同じ目標を目指すプロから中立的な助言をもらえる</li>
                                    <li>安定的な運用によってストレスの少ない運用を目指したい</li>
                                    <li>資産運用に自信を取り戻す</li>
                                </ul>
                            </dd>
                        </dl>
                        <h3><span>あなたのお悩みを解決する<br class="spmode">世界の優秀なヘッジファンドを</span><br><span>ヘッジファンドダイレクトが<br class="spmode">あなたに代わってお探しします！</span></h3>
                    </div>
                </div>
            </div>
            <!-- edit-area type01 -->
            ...
            <div class="edit-area type02 num01">
                <h3>ヘッジファンドダイレクトの<br class="spmode">強み</h3>
                <div class="white-zone">
                    <div class="inner">
                        <div class="block column num01">                          
                            <h4>投資助言実績</h4>
                            <div class="box">
                                <div class="item half">
                                    <dl>
                                        <dt>サービス継続率</dt>
                                        <dd>95.6<span class="unit">%</span><span class="cap">※2022年度実績</span></dd>
                                    </dl>
                                </div>
                                <div class="item half">
                                    <dl>
                                        <dt>投資助言契約額累計<span>国内最大手</span></dt>
                                        <dd>1361.3<span class="unit">億円</span><span class="cap">※2022年末</span></dd>
                                    </dl>
                                </div>
                                <div class="item">
                                    <dl>
                        ...
                        <div class="block column num02">    
                            <h4>ファンド成績<br class="pcmode">一例</h4>
                            <div class="flow">
                                <div class="txt">
                                    <ul>
                                        <li>リーマンショック時に55%のリターン</li>
                                        <li>コロナショック時に8.8%のリターン</li>
                                        <li>2022年、ウクライナ情勢や利上げがある中、年間25.2%のリターンを達成！</li>
                                    </ul>
                                    <p>世界中の多くのアセットクラスが下落する相場においても<br class="pcmode">ヘッジファンドなら高いリターンを期待できる！</p>
                                </div>
                                <div class="photo">
                                    <img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type02-img01.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="edit-area type04">
                <div class="inner w1080">
                    ...
                    <h3>ヘッジファンドダイレクトが選ばれている<br><span>4つの理由</span></h3>

                    <div class="photo-set mb80">
                        <h4 title="01">低リスクの安定運用が可能な仕組み</h4>
                        <div class="box">
                            <div class="photo">
                                <img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type04-img01.jpg" alt="">
                            </div>
                            <div class="txt">
                                <p>ヘッジファンドはハイリスクなイメージがあるかもしれませんが、実は他のアセットクラスよりリスクが低く、「低リスクで高リターン」な運用効率を誇るアセットクラスです。<br>相場が乱高下していても、ヘッジファンドは変動を抑えられます。</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="photo-set mb80">
                        <div class="box">
                            <div class="photo">
                                <img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type04-img02.jpg" alt="">
                            </div>
                            <div class="txt">
                                <p class="cap">表の見方<br>
                    ...
                    <div class="photo-set mb100">
                        <div class="box">
                            <div class="photo">
                                <img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type04-img03.jpg" alt="">
                            </div>
                            <div class="txt">
                                <p>複数のヘッジファンドに分散投資することで、ほとんど右肩上がりな安定運用をしているヘッジファンドもあります。<br>当社なら世界中のヘッジファンドの中から、あなたにぴったりのヘッジファンドを見つけられます。</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="photo-set mb100">
                        <h4 title="02">下げ相場でもリターンを出したファンドをご紹介</h4>
                        <div class="box">
                            <div class="photo">
                                <img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type04-img04.jpg" alt="">
                            </div>
                            <div class="txt">
                                <dl>
                                    <dt>ヘッジファンド独自の投資の仕組みが、<br class="pcmode">相場に左右されない収益構造を作り出します</dt>
                                    <dd><p>【例】ロング・ショート戦略<br>株を空売り（ショート）することで、株価が下がっても利益を出すことができます</p></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="photo-set mb80">
                        <h4 title="03">長期的に10%以上のリターンを目指せるファンドをご紹介</h4>
                        <div class="box">
                            <div class="photo">
                                <img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type04-img05.jpg" alt="">
                            </div>
                            <div class="txt">
                                <p>平均年利10%以上を10年間以上継続している実績のあるファンドをご紹介します。<br>設定来年率リターン17.6%という圧倒的な成績のファンドもあります。</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="photo-set mb100">
                        <div class="box">
                            <div class="photo">
                                <img class="pcmode" src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type04-img06.jpg" alt="">
                                <img class="spmode" src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type04-img06_sp.jpg" alt="">
                            </div>
                            <div class="txt">
                                <p>当社はファンド側（売り手）からの販売手数料を一切受け取りません。<br>当社のお客様は、海外のヘッジファンドへ直接投資するため、日本で組成されているヘッジファンド型投資信託と比較して、中間業者を中抜きすることで「コスト控除後のリターン」の最大化を目指すことができます。</p>
                            </div>
                        </div>
                    </div>


                    <div class="photo-set type02">
                        <h4 title="04">お客様と当社の目標が完全に一致している仕組み</h4>
                        <div class="box">
                            <div class="photo">
                                <img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type04-img07-01.jpg" alt="">
                            </div>
                            <div class="txt">
                                <p>証券会社は顧客が売買をすると利益が出る一方、投資助言業である当社は、お客様の資産額に応じて当社の助言料が決定します。<br>
                                    そのため、我々はあなたの資産を増やすことだけを追求します。<br>また、投資先ファンドと利害関係がないので、本当にお客様にとって良いファンドのみを厳選しておすすめします。</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="edit-area type06">
                <div class="inner w1080">
                    <h4><span>プロの投資家こそ注目しているヘッジファンド</span></h4>
                    <div class="photo-set">
                        <div class="photo">
                            <img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type06-img01.jpg" alt="">
                        </div>
                        <div class="txt">
                            <dl>
                                <dt>世界の富裕層や機関投資家は、<br class="pcmode">投資ポートフォリオにヘッジファンドを入れ<br class="pcmode">投資全体のリスクをヘッジ（回避）している</dt>
                                <dd>ハーバード大学では、資産全体の1/3程度をヘッジファンドに割り当てています。（2021年6月末時点）<br>世界の富裕層や年金基金等の機関投資家は、ポートフォリオの中に「株や債券と異なる値動きをするアセットクラス」であるヘッジファンドを入れることで、ポートフォリオ全体のリスクをヘッジ（回避）しています。左の図は世界最高の運用集団と称されるハーバード大学基金のポートフォリオです。最先端の研究成果に基づく意思決定には学ぶことが多いと言えます。</dd>
                            </dl>
                        </div>
                    </div>
                    <p>ヘッジファンドダイレクトは、<br>中立的な立場で本当によいファンド<br class="spmode">だけをご紹介します。<br>
                        <span><span>不安な情勢の今だからこそ、</span><br class="spmode"><span>有名海外ヘッジファンドで</span><br class="spmode"><span>安定した投資を！</span></span>
                    </p>
                </div>
            </div>
            ...
            <div class="edit-area type07">
                <div class="inner w1080">
                    <h4><span>投資で勝つため</span>の<span>重要なポイント</span></h4>
                    <ul>
                        <li><dl>
                            <dt>長期で続けること</dt>
                            <dd>複利効果が働くので経済危機のタイミングにおいても「やめないこと」が重要です。</dd>
                        </dl></li>
                        <li><dl>
                            <dt>正しい情報を得る</dt>
                            <dd>巷のブームに乗って「レバナス」などに投資をして大損した方もいるので、本当に信用できるアドバイザーを見つけましょう。</dd>
                        </dl></li>
                        <li><dl>
                            <dt>下げ相場に強い投資先</dt>
                            <dd>プロに相談することで実績のあるファンドを見極め、運用効率の良い資産に投資することがポイントです。</dd>
                        </dl></li>
                    </ul>
                    <p>当社ヘッジファンドダイレクトは<br class="spmode"><span>サービス継続率95.6％</span><br><span>長期的に安定した資産運用を</span><br class="spmode">サポートいたします</p>
            ...
            <div class="edit-area type02 num02">
                <div class="inner w1080">
                    <div class="block faq">
                        <h4>「決めた理由は、その実績です」<span>ヘッジファンドへの投資に成功した富裕層の声</span></h4>
                        <div class="photo-set">
                            <div class="photo">
                                <img class="pcmode" src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type02-img02.jpg" alt="ヘッジファンドダイレクト株式会社">
                                <img class="spmode" src="<?php bloginfo('template_directory') ?>/img/lp/texted02/type02-img02_sp.jpg" alt="ヘッジファンドダイレクト株式会社">
                            </div>
                            <dl>
            ...
            <div class="edit-area type09">
                <div class="inner">
                    ...
                    <div class="box">
                        <dl>
                            <dt>ですが、ご安心ください。</dt>
                            <dd><p>既に<span>「業務改善済み」と金融庁の公式HP</span>に公表されております（上記リンクからご覧ください）<br>
                                当社に対する処分事由は、顧客資産を棄損した等ではなく、当該新事業に必要なライセンス（登録）の種類に関する問題が主でした。<br>
                                その登録上の問題を解決し、規制に対応した上で、2014年に無事に業務を再開しております。<br>
                            その経緯は、2021年5月出版、当社会長著書<a href="https://hedgefund-diamond.jp/" target="_blank">「富裕層のためのヘッジファンド投資入門」（ダイヤモンド社）</a>でもご覧いただけます。</p></dd>
                        </dl>
                    </div>
                    ...
                    <div class="achievement">
                        <h4>
                            業務再開を果たしたその後の<span class="sub">8年間を通じてお客様を増やして、</span><br>
                        ...
                        <dl class="ratio">
                            ...
                            <dd>
                                <span class="num">95.6</span><span class="unit">%</span>
                            </dd>
                        </dl>
                    </div>
                </div>
                    ...
                    <li>
                        ...
                        <div class="info-txt">
                            ...
                            <table class="fsa-logo">
                                <tbody><tr>
                                    <td class="fsa-logoR"><a href="https://www.fsa.go.jp/" target="_blank"><img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/fsa.jpg" alt="金融庁ホームページ"></a></td>
                                    <td><a href="https://lfb.mof.go.jp/kantou/" target="_blank"><img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/kantou-mof.jpg" alt="財務省関東財務局"></a></td>
                                </tr>
                            </tbody></table>
                        </div>
                    </li>
                    <li>
                        <figure><img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/foot_img02.png" data-original="<?php bloginfo('template_directory') ?>/img/lp/texted02/foot_img02.png" class="lazy" alt="高岡壮一郎著「富裕層のNo.1投資戦略」（総合法令出版）" style="display: inline;"></figure>
                        <div class="info-txt">
                            ...
                            <div class="img-btn"><a href="https://sogohorei-books-wealthinvest.com/" target="_blank" rel="nofollow"><img src="<?php bloginfo('template_directory') ?>/img/lp/texted02/book_bnr_pc.png" data-original="<?php bloginfo('template_directory') ?>/img/lp/texted02/book_bnr_pc.png" class="switch lazy" alt="「富裕層のNo.1投資戦略」特設サイト" style="display: inline;"></a></div>
                        </div>
                    </li>
                </ul>
            </div>
